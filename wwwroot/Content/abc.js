...
{
 "use strict";
 var abc,Client,WebSharper,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,TemplateHole,Var,Handler,EventTarget,Node,Strings,Unchecked,abc_Templates,Error,MatchFailureException,Utils,ConcreteVar,Snap,TemplateHoleModule,TextView,Text,System,Guid,EventQ,Client$1,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Collections,Dictionary,Object,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,JS,VarDomElement,View,Numeric,DictionaryUtil,Enumerator,T,WindowOrWorkerGlobalScope,SC$1,Docs,SC$2,DocElemNode,CharacterData,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,SC$4,SC$5,AppendList,DynamicAttrNode,KeyNotFoundException,SC$6,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,BindVar,String,CheckedInput,CancellationTokenSource,DomNodes,Char,DateUtil,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,math,Runtime$1,Math,console,Date;
 abc=Global.abc=Global.abc||{};
 Client=abc.Client=abc.Client||{};
 ...
 abc_Templates=Global.abc_Templates=Global.abc_Templates||{};
 Error=Global.Error;
 ...
 {
  var display,wholeEq,lastEq,showingResult,_,b,t,D,_this,S,c,_this$1,L,_this$2,W,_this$3,p,i;
  function formatNum(number)
  {
   var parts;
   parts=Strings.SplitChars(number.toExponential(),["e"],0);
   return Utils.toSafe(Global.Number(Arrays.get(parts,0)).toFixed(3))+"E"+Global.String(Operators.toInt(Global.Number(Arrays.get(parts,1))));
  }
  function _eval(str)
  {
   var c$1,rsltFloat,fr,m;
   rsltFloat=Global.Number(Global.String(math.evaluate(str)));
   fr=(c$1=math.round(rsltFloat,8),Global.String(c$1));
   m=Strings.length(fr);
   if(m<=8)
    return fr;
   else
    if(m>8)
     return formatNum(rsltFloat);
    else
     throw new MatchFailureException.New("Client.fs",42,18);
  }
  display=Var$1.Create$1("0");
  wholeEq=Var$1.Create$1("");
  lastEq=Var$1.Create$1("");
  showingResult=Var$1.Create$1(true);
  _=(b=(t=(D=display.get_View(),(_this=(S=(c=showingResult.Get(),Global.String(c)),(_this$1=(L=lastEq.get_View(),(_this$2=(W=wholeEq.get_View(),(_this$3=new ProviderBuilder.New$1(),(_this$3.h.push(new TextView.New("wholeeq",W)),_this$3))),(_this$2.h.push(new TextView.New("lasteq",L)),_this$2))),(_this$1.h.push(new Text.New("showingresult",S)),_this$1))),(_this.h.push(new TextView.New("display",D)),_this))),(t.h.push(Handler.EventQ2(t.k,"click",function()
  {
   return t.i;
  },function(e)
  {
   var $1,m,m$1,$2,$3,$4,m$2;
   m=e.Target.className;
   switch(m)
   {
    case"9":
    case"8":
    ...
    case"1":
    case"0":
     if(showingResult.Get())
      {
       Var$1.Set(display,e.Target.className);
       Var$1.Set(lastEq,Global.String(lastEq.Get())+e.Target.className);
       Var$1.Set(showingResult,false);
      }
     else
      Strings.length(Global.String(display.Get()))<=8?(Var$1.Set(display,Global.String(display.Get())+e.Target.className),Var$1.Set(lastEq,Global.String(lastEq.Get())+e.Target.className)):Var$1.Set(display,Global.String(display.Get()));
     break;
    case"=":
     if(wholeEq.Get()=="")
      Var$1.Set(wholeEq,wholeEq.Get());
     else
      {
       m$1=lastEq.Get();
       m$1=="/"||(m$1=="+"||(m$1=="-"||m$1=="*"))?Var$1.Set(lastEq,""):(Var$1.Set(wholeEq,_eval(Global.String(Global.String(wholeEq.Get())+Global.String(lastEq.Get())))),Var$1.Set(display,wholeEq.Get()),Var$1.Set(showingResult,true),Var$1.Set(lastEq,""));
      }
     break;
    case"ac":
     Var$1.Set(lastEq,"");
    ...
    default:
     ...
     {
      case"":
       $3=wholeEq.Get()==""?Var$1.Set(lastEq,""):(Var$1.Set(wholeEq,wholeEq.Get()),Var$1.Set(lastEq,e.Target.className));
       break;
      case"*":
      case"-":
      case"+":
      case"/":
       $3=Var$1.Set(lastEq,e.Target.className);
       break;
      default:
       $3=(Var$1.Set(wholeEq,Global.String(math.evaluate(Global.String(wholeEq.Get())+Global.String(lastEq.Get())))),Var$1.Set(display,wholeEq.Get()),Var$1.Set(showingResult,true),Var$1.Set(lastEq,e.Target.className));
       break;
     }
     $3;
     break;
   }
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],abc_Templates.main(p[0])),b.i=i,i))).get_Doc();
